...
def clean_colloquial_speech(text: str) -> str:
    ...
    corrections = [
        ...
        (r'\b3\s*x\s*12\b|\b3\s+por\s+12\b|\btres\s+por\s+doce\b', '3x2'),
        (r'\b3\s*x\s*2\b|\b3\s+por\s+2\b|\btres\s+por\s+dos\b', '3x2'),
        (r'\b2\s*x\s*1\b|\b2\s+por\s+1\b|\bdos\s+por\s+uno\b', '2x1'),
        (r'\bestuprojando\b|\bestoyprojando\b|\bestu\s+preguntando\b|\bes\s+preguntando\b', 'estoy preguntando'),
        (r'\bfein\b|\bfeis\b|\bfeisbuc\b|\bfeisbuk\b|\bfeibu\b', 'Facebook'),
